...
const FollowUpModal = ({ onSubmit, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const appointmentData = { patientId: pid, doctorId: did, date: date, status: 'Scheduled', description, hour };

      const response = await axios.post(`http://localhost:4000/createAppointment`, appointmentData, {
        withCredentials: true,
      });
